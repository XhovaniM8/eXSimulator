...
int main() {
    ...
    printf("\nTest 2: Market order\n");
    {
        ...
        printf("Market filled: %u @ $%.4f\n", 
               result.filled_qty, price_to_double(10100));
    }
    ...
    printf("\nTest 3: PostOnly (rejects if crosses)\n");
    {
        ...
        Order postonly_sell(next_id++, symbol, Side::Sell, 9900, 50, OrderType::PostOnly);
    ...
    printf("\nTest 4: IOC\n");
    {
        ...
        Order ioc_buy(next_id++, symbol, Side::Buy, 10200, 100, OrderType::ImmediateOrCancel);
    ...
    printf("\nTest 5: FOK\n");
    {
        ...
        Order fok_sell(next_id++, symbol, Side::Sell, 9800, 100, OrderType::FillOrKill);
